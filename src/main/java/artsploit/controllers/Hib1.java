...
@LdapMapping(uri = { "/o=hibernate1" })
public class Hib1 implements LdapController {
    ...
    public void sendResult(InMemoryInterceptedSearchResult result, String base) throws Exception {
        ...
        Method m = Hibernate1.class.getMethod("getObject", String.class);
        Hibernate1 myObj = new Hibernate1();
